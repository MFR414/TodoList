...
public class MainActivity extends AppCompatActivity implements TodoAdapter.OnTodoClickedListener,TodoAdapter.OnTodoDelBtnListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = this.getSharedPreferences("PREF_TEXT",MODE_PRIVATE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            finish();
        }if (id == R.id.action_largeTextsize){
            pref.edit().putString("text_size","20").apply();
            return true;
        }if (id == R.id.action_smallTextsize){
    ...
    public void handleDelete(Todo todo) {
        int id = todo.getId();
        ...
        deleteTodo.enqueue(new Callback<Envelope<Todo>>() {
            ...
            public void onFailure(Call<Envelope<Todo>> call, Throwable t) {
                Toast.makeText(MainActivity.this,"Error while deleting this item",Toast.LENGTH_SHORT).show();
            }
        });
    }
}
